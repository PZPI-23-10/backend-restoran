...
namespace backend_restoran.Migrations
{
    ...
    [Migration("20250602182451_AddMobileDeviceToken")]
    partial class AddMobileDeviceToken
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend_restoran.Persistence.Models.Device", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("backend_restoran.Persistence.Models.Reservation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("backend_restoran.Persistence.Models.Table", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("backend_restoran.Persistence.Models.Reservation", b =>
                {
                    b.HasOne("backend_restoran.Persistence.Models.Table", "Table")
                        .WithMany("Orders")
